...
import frontend.interfaces.Gui;
...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         */
        before = System.currentTimeMillis();
        Pair<Long, Long> q3 = qe.totalPosts(
         ...
         */
        before = System.currentTimeMillis();
        List<Long> query4 = qe.questionsWithTag(
                "package-management", 
         ...
         */
        before = System.currentTimeMillis();
        List<Long> q6 = qe.mostVotedAnswers(
                50, LocalDate.of(2015, Month.NOVEMBER, 1),
        ...
        List<Long> q7 = qe.mostAnsweredQuestions(10, LocalDate.of(2014, Month.AUGUST, 1),
                LocalDate.of(2012, Month.AUGUST, 11));
        after = System.currentTimeMillis();
         ...
         */
        before = System.currentTimeMillis();
        List<Long> q11 = qe.mostUsedBestRep(5, 
                LocalDate.of(2013, Month.NOVEMBER, 01),
        ...
        */
        ...
        before = System.currentTimeMillis();
        //qe.clear(); -> objeto será limpo quando a janela é terminada
        after = System.currentTimeMillis();
